package org.iac.module.redis.service.elector;
...
import org.iac.module.core.utils.Threads;
import org.iac.module.redis.JedisTemplate;
import org.iac.module.redis.JedisUtils;
import org.iac.module.redis.pool.JedisPool;
...
public class MasterElector implements Runnable {
	...
	public void start(ScheduledExecutorService scheduledThreadPool) {
		...
		electorJob = scheduledThreadPool.scheduleAtFixedRate(new Threads.WrapExceptionRunnable(this), 0, intervalSecs,
				TimeUnit.SECONDS);
