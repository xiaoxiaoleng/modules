package org.iac.module.redis.service.scheduler;
...
import org.iac.module.redis.JedisScriptExecutor;
...
public class JobDispatcher implements Runnable {
	...
	public void start(ScheduledExecutorService scheduledThreadPool) {
		...
		dispatchJob = scheduledThreadPool.scheduleAtFixedRate(new Threads.WrapExceptionRunnable(this), 0, intervalMillis,
